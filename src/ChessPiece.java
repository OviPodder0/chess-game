...
//this initialize the graphics for the Type of piece given. It loads the png file
// of the given piece
 		if (color.equals("BLACK")) {
			graphicBlack = type + color + ".png";
		}
		else if (color.equals("WHITE")) {
			graphicWhite = type + color + ".png";
		}

		setGraphics(graphicBlack,graphicWhite);
